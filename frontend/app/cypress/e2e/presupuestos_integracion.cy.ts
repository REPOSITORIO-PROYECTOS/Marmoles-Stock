/**
 * Tests End-to-End para validar el flujo completo de Presupuestos
 * Usando Cypress para validación de UI y comportamiento
 */

describe('Flujo Completo: Crear Presupuesto con todas las funcionalidades', () => {
