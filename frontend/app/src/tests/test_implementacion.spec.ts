...
describe('Módulo 4: Pagos - Descuentos', () => {
  ...
  it('PaymentInfo debe tener estructura extendida con descuento', () => {
    const paymentInfo = {
      tipoCobro: 'contado',
      conFactura: false,
      descuento: {
...
describe('Integración: Cálculos de Total', () => {
  ...
  it('calcularTotal debe aplicar descuento antes de IVA', () => {
    let subtotal = 5000;
    const paymentInfo = {
    ...
    // IVA NO se aplica automáticamente en backend
