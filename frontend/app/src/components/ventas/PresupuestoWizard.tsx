...
export function PresupuestoWizard({ 
  ...
  return (
    <div className="space-y-6">
          ...
          <div key={step.id} className="flex flex-col items-center">
            <div 
              className={cn(
                ...
                index <= currentStep ? "bg-cyan-600 text-white" : "bg-white border-2 border-gray-200 text-gray-400"
              )}
            >
              {index + 1}
            </div>
      ...
      {/* Contenido del Paso */}
      <Card className="min-h-[500px] flex flex-col shadow-lg border-cyan-100">
        <CardHeader className="border-b bg-gray-50/50">
          <CardTitle className="text-xl text-cyan-900 flex justify-between items-center">
            {steps[currentStep].title}
            {isLastStep && (
              <div className="flex gap-2">
                <Button onClick={onPrint} className="bg-cyan-600 hover:bg-cyan-700">
            ...
            <div className="flex items-center gap-4">
              ...
              <Button 
                ...
                className={cn(
                  ...
                  canGoNext ? "bg-cyan-600 hover:bg-cyan-700" : "bg-gray-400 cursor-not-allowed opacity-70"
                )}
                disabled={!canGoNext}
              >
