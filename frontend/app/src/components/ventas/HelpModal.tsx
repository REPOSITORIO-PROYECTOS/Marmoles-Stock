  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-cyan-900 flex items-center gap-2">
            <Info className="text-cyan-600" /> Flujo de Registro de Presupuesto
          </DialogTitle>
        </DialogHeader>
        <div className="space-y-6 py-4">
          <div className="grid grid-cols-1 gap-4">
            <div className="flex gap-4 p-4 rounded-lg bg-cyan-50 border border-cyan-100">
              <div className="bg-cyan-600 text-white w-8 h-8 rounded-full flex items-center justify-center shrink-0 font-bold">1</div>
              <div>
