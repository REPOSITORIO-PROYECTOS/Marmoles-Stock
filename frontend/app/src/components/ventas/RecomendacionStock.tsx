...
export function RecomendacionStock({
  ...
  return (
    <Card className={`border-2 ${recomendacion.tipo === 'retazo' ? 'border-emerald-500 bg-emerald-50' : 'border-cyan-500 bg-cyan-50'} animate-in fade-in slide-in-from-bottom-4 duration-500`}>
      <CardContent className="p-4">
        <div className="flex items-start gap-3">
          <div className={`p-2 rounded-lg ${recomendacion.tipo === 'retazo' ? 'bg-emerald-100' : 'bg-cyan-100'}`}>
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              <h4 className={`text-sm font-bold uppercase tracking-tight ${recomendacion.tipo === 'retazo' ? 'text-emerald-700' : 'text-cyan-700'}`}>
