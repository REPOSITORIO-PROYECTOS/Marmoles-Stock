...
interface Props {
  ...
  /** Sin Card/título: para modal del constructor de presupuestos */
  embedded?: boolean;
  /** Oculta el combobox de selección (modal solo alta/edición) */
  hideSelector?: boolean;
  /** Solo nombre / tel / email — sin dirección ni mapa (presupuesto: obra aparte) */
  soloDatosContacto?: boolean;
}
        ...
        {clienteId ? (
          <div
            className={cn(
              ...
              soloDatosContacto ? 'space-y-3' : 'space-y-4',
            )}
          >
            <div
              className={cn(
                'grid gap-3 sm:gap-4',
                soloDatosContacto ? 'grid-cols-1' : 'grid-cols-1 md:grid-cols-2',
              )}
            >
              <div className="space-y-2">
                ...
                <>
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      isFormValid ? "bg-blue-600 hover:bg-blue-700" : "bg-gray-400 cursor-not-allowed opacity-70"
                    )}
