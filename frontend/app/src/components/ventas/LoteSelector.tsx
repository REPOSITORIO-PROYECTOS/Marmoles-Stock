              ...
              {selectedMaterial ? (
                <div className="flex flex-col items-start">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-lg font-black">{selectedMaterial.nombre}</span>
                    {typeof selectedMaterial.precio_m2 === 'number' ? (
                      <span className="text-sm font-bold text-muted-foreground bg-muted px-2 py-0.5 rounded">
                ...
                <span className="text-base font-semibold text-muted-foreground">Elegir Mármol, Granito, Cuarzo...</span>
              )}
          ...
          <Popover open={openLote} onOpenChange={setOpenLote}>
            <PopoverTrigger asChild>
              <Button
                ...
                className={cn(
                  "w-full justify-between min-h-[80px] h-auto p-4 bg-white border-2 transition-all",
                ...
                {selectedLote ? (
                  <div className="flex flex-col items-start w-full">
                    ...
                    <div className="flex gap-4 text-xs font-bold text-muted-foreground">
                      ...
                      <span className="truncate max-w-[150px]">{selectedLote.ubicacion}</span>
                    </div>
                  </div>
                ) : (
                  <div className="flex flex-col items-start">
            ...
            <PopoverContent className="w-[700px] p-0" align="start" side="bottom">
              <Command>
