        ...
        {plan && (
          <div className="mt-4 grid grid-cols-3 gap-4 text-sm">
            <div className="bg-blue-50 p-3 rounded-lg">
              <div className="text-xs text-blue-600 font-bold uppercase">Dimensiones Plancha</div>
              <div className="text-lg font-black text-blue-900">{plan.effective_board.width.toFixed(1)} x {plan.effective_board.height.toFixed(1)} cm</div>
            </div>
