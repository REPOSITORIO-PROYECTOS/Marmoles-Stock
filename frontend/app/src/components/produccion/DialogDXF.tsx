                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:bg-gray-50 transition-colors">
                        <Label htmlFor="dxf-upload" className="cursor-pointer block w-full h-full">
                            <div className="flex flex-col items-center gap-2">
                                ...
                                <span className="text-sm text-gray-600">Click para seleccionar archivo DXF</span>
                            </div>
                            <Input
                                id="dxf-upload"
                                type="file"
                                ...
                                <div className="space-y-2 text-sm">
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        <div className="bg-white p-2 rounded border">
                                            ...
                                            <div className="font-mono text-lg">{dxfResult.entity_count || 0}</div>
                                        </div>
                                        <div className="bg-white p-2 rounded border">
                                        ...
                                        <div className="col-span-2 bg-white p-2 rounded border">
                                            ...
                                            <div className="font-mono text-lg font-bold text-cyan-600">
                                                {dxfResult.total_area_m2?.toFixed(2) || '0.00'} m²
                                            </div>
