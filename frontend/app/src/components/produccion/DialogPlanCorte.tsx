...
export function DialogPlanCorte({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-5xl w-full h-fit max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                            {dialogData.trabajos.map((t, trabajoIdx) => {
                                ...
                                return (
                                    <div key={t.id} className="p-3 border rounded-md bg-muted/30 relative group">
                                                    ...
                                                    {piezasParaMostrar.map((pieza, idx) => {
                                                        ...
                                                        return (
                                                            <div key={idx} className="text-xs bg-background/50 px-2 py-1 rounded">
                                                                <span className="font-bold text-cyan-600">{t.cliente} - Pieza {idx + 1}</span>
                    ...
                    <div className="flex justify-end gap-2 sticky bottom-0 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/75 py-2 border-t">
                        <Button onClick={handleImprimirYCrearLote} className="bg-cyan-600 hover:bg-cyan-700">
