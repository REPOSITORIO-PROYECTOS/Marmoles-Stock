  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="bg-white border-l-4 border-l-cyan-500 shadow-sm">
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              ...
              <div className="p-2 bg-cyan-50 rounded-full"><FileText className="h-5 w-5 text-cyan-600" /></div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-4 mt-6">
        {filteredPagos.length === 0 ? (
          ...
          filteredPagos.map((item) => {
            ...
            return (
              <Card key={item.id} className="hover:border-cyan-300 transition-all border-l-4 border-l-transparent hover:border-l-cyan-500 overflow-hidden shadow-sm">
                  ...
                  <div className="flex flex-col md:flex-row justify-between gap-4 mb-4 border-b border-dashed pb-4">
                    <div className="space-y-1 min-w-0 flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <Badge className={item.estado_pago === 'pagado' ? 'bg-green-100 text-green-700 hover:bg-green-100' : 'bg-cyan-100 text-cyan-700 hover:bg-cyan-100'}>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative h-5 w-full bg-gray-100 rounded-full overflow-hidden border border-gray-200 shadow-inner">
                        <div
                          className={`h-full transition-all duration-1000 flex items-center justify-center text-[10px] font-bold text-white shadow-sm ${pct === 100 ? 'bg-green-500' : pct > 0 ? 'bg-cyan-500' : 'bg-amber-500'
                            }`}
                          style={{ width: `${pct}%` }}
                        >
                      ...
                      <div className="flex justify-between items-center text-[10px] font-bold uppercase tracking-tighter">
                        ...
                        <span className="text-gray-400">SEGUIMIENTO DE PAGOS</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-end gap-2 items-center">
                      <Button
                        ...
                        className={`text-gray-500 hover:text-cyan-600 hover:bg-cyan-50 transition-colors ${isExpanded ? 'bg-cyan-50 text-cyan-600' : ''}`}
                      >
                      ...
                      <Button
                        ...
                        disabled={item.estado_pago === 'pagado'}
                      >
                        <DollarSign className="h-4 w-4 mr-1" /> Registrar Pago
                      </Button>

                      <Button variant="ghost" size="icon" className="h-9 w-9 text-gray-400 hover:text-cyan-500">
                      ...
                      <div className="mt-6 pt-6 border-t animate-in slide-in-from-top-2 duration-300">
                        <div className="bg-gray-50 rounded-lg p-4 space-y-6">
                                ...
                                {items.map((line, idx) => (
                                  <div key={idx} className="flex justify-between items-center bg-white p-3 rounded border border-gray-100 shadow-sm">
                                    <div className="flex items-center gap-3 min-w-0">
                                      <div className="h-8 w-8 bg-cyan-50 rounded flex items-center justify-center text-cyan-600 font-bold text-xs shrink-0">
                                        {line.cantidad}x
                                      </div>
                          ...
                          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-white/50 p-4 rounded-lg border border-dashed border-gray-300">
                            ...
                            <Button variant="link" className="text-cyan-600 font-bold h-auto p-0 flex items-center gap-1">
