...
export function EncuestaPublica() {
    ...
    if (loading) {
        return (
            <div className="flex h-screen items-center justify-center bg-gradient-to-br from-cyan-50 to-indigo-50">
    ...
    if (!encuesta) {
        return (
            <div className="flex h-screen items-center justify-center bg-gradient-to-br from-cyan-50 to-indigo-50 p-4">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-indigo-50 py-6 md:py-12 px-4">
            <Card className="w-full max-w-2xl mx-auto shadow-lg border-0">
                <CardHeader className="bg-gradient-to-r from-cyan-600 to-indigo-600 text-white p-6 md:p-8 rounded-t-lg">
