# Resumen del Proyecto Mundo di Marmi

## 1. Objetivo general

Mundo di Marmi es un sistema de gestión para marmolería en formato monorepo. Está diseñado para centralizar operaciones comerciales, productivas y logísticas en una sola plataforma.
...
- ORM: SQLAlchemy
- Migraciones: Alembic
- Base de datos principal: PostgreSQL (desarrollo local vía Docker; las migraciones Alembic requieren Postgres)
